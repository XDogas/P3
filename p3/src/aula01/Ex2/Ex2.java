...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		do {
			out.println("\nMENU");
			out.println("1: Adicionar pessoa á lista");
			...
			if(op != 1 && op != 2 & op != 3 && op != 4 & op != 5 && op != 6) out.println("Opção inválida\nTente novamente");
	...
	private static void deleteP() {
		...
		do {
			...
			if(op.equals("nome")) {
				...
				else out.println("Pessoa não presente na lista");
			...
			} else out.println("Opção inválida. Tente novamente");
