...
public class Test {
	...
	public static void main(String[] args) throws IOException {
		...
		ementa.saveInFile();		// Guarda a ementa num ficheiro de texto chamado "Ementa.txt" na pasta Files
		System.out.println("Ficheiro de texto (Ementa.txt) com a ementa guardado na pasta Files");
	}
